...
class Xception(nn.Module):              # Xception backbone in DeepLabV3+ is different from original Xception network

    def __init__(self, os, input_channel=None):
        ...
        self.conv1 = nn.Conv2d(input_channel, 32, 3, 2, 1, bias=False)         
